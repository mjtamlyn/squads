...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('time', models.PositiveIntegerField(verbose_name=b'Time (in minutes)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('description', models.TextField(default=b'', blank=True)),
                ('category', models.ForeignKey(to='squads.TrainingCategory')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='user',
            name='squad',
            field=models.ForeignKey(blank=True, to='squads.Squad', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='user',
